...
- As CSM: I own end-to-end customer success for five global Fortune-level accounts — P&G (Asia, ~$500K), PepsiCo (Asia & Americas, ~$138K), Takasago (Americas, EU, Asia, ~$120K), Winland Foods (US, ~$120K), and Sun Pharma (South Africa, Thailand, Nigeria, ~$36K) — spanning FMCG, Flavour & Food, and Pharma, with combined ARR of $914K, delivered through the full Convosight product suite. I lead onboarding and drive product adoption by solving live client use cases on-platform, translating consumer voice into decisions across brand, marketing, and innovation. I act as day-to-day trusted advisor, resolving queries and growing account health, satisfaction, retention, and expansion. I built a proactive account health framework that segments accounts by usage signals to flag risk early and surface expansion opportunities.
- Previous role: Senior Analyst — Consumer Insights & Social Intelligence at Convosight (Dec 2024 – Mar 2026). I was sole point of contact across the full report lifecycle, from client briefing calls through final delivery, personally presenting all 50+ executive-ready analyses to clients across 3+ international markets, while generating the highest revenue on the team (INR 2.6 Cr) with zero missed deadlines across multi-market, multi-phase studies. I proactively automated a manual internal reporting process by building two tools — an influencer vetting platform, and a separate platform combining sentiment analysis and a purchase intent classification model — using Python, Vercel, and Claude Code to ship quickly, saving 5–6 man-hours per day across the team. I monitored sentiment and campaign effectiveness across 5+ digital channels for 10+ global brands. A client (a global pharma & FMCG brand's Southeast Asia division) called one of my deliverables "the best insights report I've seen in my career of more than 12 years into social listening." I also collaborated with product, engineering, and marketing to integrate social performance data into client workflows, supporting A/B testing across 3+ campaigns — and managed a wedding break mid-cycle with zero disruption to deliverables (I got married!).
- Before that: Data Analyst at Sundaram-Clayton Limited (Jul 2023 – Oct 2024), Chennai, India. Built and maintained 10+ Power BI and Excel dashboards across Marketing, Finance, and Sales, optimizing business operations by 20% while holding SLA data quality standards. Coordinated across 5+ divisions to investigate and resolve data discrepancies, saving 5–6 hours weekly through structured reporting improvements.
...
- Tools: Python, SQL, Power BI, Tableau, Streamlit, Mixpanel, Vercel, Claude Code, Excel, Google Workspace, Project Management.
